...
const Application = new Lang.Class({
    ...
    _init: function() {
        this.application = new Gtk.Application({
            application_id: "org.modulo.ubby",
    ...
    _buildUI: function() {
        ...
        try {
            let icon = Gtk.IconTheme.get_default().load_icon("ubby", 48, 0);
    ...
    _loadPlugins: function() {
        ...
        // User plugins
        let user = this._loadPluginsFromDir(GLib.get_user_data_dir() + "/ubby/plugins");
    ...
    _loadConfig: function() {
        ...
        // User config
        let user = this._loadJSON(GLib.get_user_data_dir() + "/ubby/config.json");
